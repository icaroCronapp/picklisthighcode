...
public class Role implements Serializable {
    ...
    * @generated
    */
    @CronappColumn(attributeType="BOOLEAN", label="{{'Builtin' | translate}}")
    ...
    * @generated
    */
    @CronappColumn(attributeType="BOOLEAN", label="{{'MembershipEnabled' | translate}}")
    ...
    * @generated
    */
    @CronappColumn(attributeType="STRING", label="{{'NormalizedName' | translate}}")

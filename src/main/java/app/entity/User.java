...
public class User implements Serializable {
    ...
    * @generated
    */
    @CronappColumn(attributeType="INTEGER", label="{{'AccessFailedCount' | translate}}")
    ...
    * @generated
    */
    @CronappColumn(attributeType="BOOLEAN", label="{{'EmailConfirmed' | translate}}")
    ...
    * @generated
    */
    @CronappColumn(attributeType="BOOLEAN", label="{{'LockoutEnabled' | translate}}")
    ...
    * @generated
    */
    @CronappColumn(attributeType="STRING", label="{{'NormalizedEmail' | translate}}")
    ...
    * @generated
    */
    @CronappColumn(attributeType="STRING", label="{{'NormalizedUserName' | translate}}")
    ...
    * @generated
    */
    @CronappColumn(attributeType="BOOLEAN", label="{{'PhoneNumberConfirmed' | translate}}")
    ...
    * @generated
    */
    @CronappColumn(attributeType="STRING", label="{{'SecurityStamp' | translate}}")
    ...
    * @generated
    */
    @CronappColumn(attributeType="BOOLEAN", label="{{'TwoFactorEnabled' | translate}}")
